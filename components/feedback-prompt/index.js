...
feedbackPromptTemplate.innerHTML = /* html */ `
  ...
  .survey {
    ...
    left: 50%;
    z-index: 1;
    background: linear-gradient(168.33deg, #000000 0%, #000000 100%);
    padding: 24px 32px;
    width: max-content;
  ...
  <div class="survey" id="survey-container">
    ...
    <div class="btn-container">
      <a class="btn-primary" id="ok-button" href="https://www.youtube.com/channel/UCD__5WE6_NKEJ2dcyXnjq7g/featured" target="_blank">
