...
headerTemplate.innerHTML = /* html */ `
  ...
  <header class="row">
    ...
    <div class="menu row">
      ...
      <a
        href="/pages/biomol.html"
        class="menu-link"
      >
        <intl-message key="menu.biomol"></intl-message>
      </a>

      <a
        href="/pages/solobilim.html"
        class="menu-link"
      >
        <intl-message key="menu.solobilim"></intl-message>
      </a>
  ...
  <div id="mobile-menu-lang" class="mobile-menu column">
    <div class="mobile-menu-content column">
      ...
      <a class="mobile-menu-link" id="en_">
        ...
        <a class="mobile-menu-link" id="ru_">
          Русский
        </a>
      </div>
    </div>
